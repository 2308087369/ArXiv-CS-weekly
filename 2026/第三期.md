...
>
> [![arXiv](https://img.shields.io/badge/arXiv-2601.15282-b31b1b.svg)](https://arxiv.org/abs/2601.15282) [**PDF下载**](../Resource/第三期/2601.15282v1.pdf)
...
>
> [![arXiv](https://img.shields.io/badge/arXiv-2601.15160-b31b1b.svg)](https://arxiv.org/abs/2601.15160) [**PDF下载**](../Resource/第三期/2601.15160v1.pdf)
...
* **创造性象限（Creative Quadrant）**：任务需要多样性、发散思维（如写诗、头脑风暴）。 → **使用生成式AI**。  
* **确定性象限（Deterministic Quadrant）**：任务只有唯一解，逻辑封闭（如数学计算、文本提取、事实核查）。 → **回退到确定性算法（Regex, Symbolic Solver）**。
